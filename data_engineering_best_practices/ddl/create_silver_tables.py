...
def create_tables(
    ...
    clickzetta.sql(f"DROP TABLE IF EXISTS {schema}.dim_customer").collect()
    clickzetta.sql(
        f"""
    ...
    clickzetta.sql(f"DROP TABLE IF EXISTS {schema}.fct_orders").collect()
    clickzetta.sql(
        f"""
              CREATE TABLE {schema}.fct_orders (
                order_id STRING,
                customer_id INT,
                item_id STRING,
                item_name STRING,
